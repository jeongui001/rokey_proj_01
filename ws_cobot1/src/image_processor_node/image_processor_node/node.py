...
from vision_core.geometry import grid_centers_in_roi, pixel_to_base_on_axis_plane, transform_matrix
from vision_core.grid_projection import project_instances_to_grid
from vision_core.mosaic import fit_image, render_cells
from vision_core.overlay import draw_instance_overlay
from vision_core.palette import Palette
from vision_core.segmentation import create_segmenter, largest_contour_points
from vision_interfaces.msg import BlockCell, BlockModel, SegmentationInstance
...
class ImageProcessorNode(Node):
    ...
    def __init__(self) -> None:
        ...
        self.declare_parameter('service_name', '/vision/process_mosaic')

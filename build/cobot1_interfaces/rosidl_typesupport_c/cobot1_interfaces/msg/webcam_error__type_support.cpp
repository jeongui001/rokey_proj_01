...
static const _WebcamError_type_support_symbol_names_t _WebcamError_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cobot1_interfaces, msg, WebcamError)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, cobot1_interfaces, msg, WebcamError)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, cobot1_interfaces, msg, WebcamError)() {
  return &::cobot1_interfaces::msg::rosidl_typesupport_c::WebcamError_message_type_support_handle;
}

...
#include "cobot1_interfaces/msg/detail/block_task__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const cobot1_interfaces::msg::BlockTask & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  cobot1_interfaces::msg::BlockTask & ros_message)
{
  // Member: y_position
  cdr >> ros_message.y_position;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = cobot1_interfaces::msg::BlockTask;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const cobot1_interfaces::msg::BlockTask *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<cobot1_interfaces::msg::BlockTask *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _BlockTask__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const cobot1_interfaces::msg::BlockTask *>(
...
static size_t _BlockTask__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_BlockTask(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _BlockTask__callbacks = {
...
static rosidl_message_type_support_t _BlockTask__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_BlockTask__callbacks,
...
{
  return &cobot1_interfaces::msg::typesupport_fastrtps_cpp::_BlockTask__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cobot1_interfaces, msg, BlockTask)() {
  return &cobot1_interfaces::msg::typesupport_fastrtps_cpp::_BlockTask__handle;
}

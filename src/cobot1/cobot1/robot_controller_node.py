...
KITTING_TRAY_PROFILES = {
    "yellow": {
        "2x2": KittingTrayProfile(
            ...
            pick_pose=CartesianPose(261.42, -101.5,  17.50, 90.00, -147, 90.38),
        ...
        "3x2": KittingTrayProfile(
            ...
            pick_pose=CartesianPose(313.0, -110.0-1.2,  18.0, 90.00, -147, 90.38),
            tool_retract_z_mm=-40.0,
        ),
    },
    "red": {
        "2x2": KittingTrayProfile(
            ...
            pick_pose=CartesianPose(366.8, -101.5,  17.50, 90.00, -147, 90.38),
            tool_retract_z_mm=-40.0,
        ),
        "3x2": KittingTrayProfile(
            profile_id="red_3x2",
            ...
            pick_pose=CartesianPose(419.66, -110.0-1.2,  18.0, 90.00, -147, 90.38),
            tool_retract_z_mm=-40.0,
        ),
    },
    "blue": {
        "2x2": KittingTrayProfile(
            ...
            pick_pose=CartesianPose(496.35, -100,  17.50, 90.00, -147, 90.38),
            tool_retract_z_mm=-40.0,
        ),
        "3x2": KittingTrayProfile(
            profile_id="blue_3x2",
            ...
            pick_pose=CartesianPose(549.46, -107.0,  25.0, 90.00, -147, 90.38),
            tool_retract_z_mm=-40.0,
        ),
    },
    "green": {
        "2x2": KittingTrayProfile(
            ...
            pick_pose=CartesianPose(603.24, -101.5,  17.50, 90.00, -147, 90.38),
            tool_retract_z_mm=-40.0,
        ...
        "3x2": KittingTrayProfile(
            ...
            pick_pose=CartesianPose(658.35, -110.0,  18.0, 90.00, -147, 90.38),
            tool_retract_z_mm=-40.0,
            waypoint_pose=CartesianPose(550.0, -97.78, 270.0, 89.97, -179.68, 90.34),
        ),
    },
